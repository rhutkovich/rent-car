...
<html>
	<head>
		...
		<fmt:setBundle basename="com.epam.rentcar.internalization.confirm.ConfirmPageContent" var="client_lang" />
		<fmt:setBundle basename="com.epam.rentcar.internalization.main.MainContent" var="lang" />
		<!-- --------------- -->
